...
DEMO_TENANT=$(get_id keystone tenant-create --name=$USER_PROJECT)
#INVIS_TENANT=$(get_id keystone tenant-create --name=invisible_to_admin)

# Users
ADMIN_USER=$(get_id keystone user-create --name=admin --pass="$ADMIN_PASSWORD" --email=admin@domain.com)
DEMO_USER=$(get_id keystone user-create --name="$USER_PROJECT" --pass="$ADMIN_PASSWORD" --email=demo@domain.com)
